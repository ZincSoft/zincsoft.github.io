...
def pull
  ...
  system('git subtree pull --prefix src/projects/catnet/rfc/markdown catnet-rfcs main --squash')
end
...
def transpile(file)
  ...
  html_data = html_data.gsub("<p>", "<p class=\"text-xl lg:text-justify tracking-wide\">")
  html_data = html_data.gsub("<pre>", "<pre class=\"py-8 text-xl lg:text-justify tracking-wide\">")
  ...
  html_data = html_data.gsub("<table>", "<table class=\"text-center border-2 border-black text-xl text-left text-gray-500\">")
  html_data = html_data.gsub("<thead>", "<thead class=\"border-2 border-black text-xl text-gray-700 uppercase\">")
  html_data = html_data.gsub("<td ", "<td class=\"border-2 border-black text-xl text-gray-700 p-4\" ")
